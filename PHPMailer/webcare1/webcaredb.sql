...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2024 at 05:16 PM
...
INSERT INTO `articles` (`articleid`, `title`, `link`, `picture`, `visit_count`) VALUES
(1, 'What does anxiety feel like, and how does it affect the body?', 'https://www.medicalnewstoday.com/articles/322510', 'images/anxiety.jpg', 4),
(2, 'Strategies for controlling your anger keeping anger in check.', 'https://www.apa.org/topics/anger/strategies-controlling', 'images/anger.png', 3),
(3, 'Understanding Academic Stress in College', 'https://jedfoundation.org/resource/understanding-academic-stress/', 'images/student.jpeg', 8),
(4, 'Dealing with Teen Depression', 'https://www.helpguide.org/articles/depression/teenagers-guide-to-depression.htm', 'images/teen.jpg', 5);
...
--
ALTER TABLE `articles`
  MODIFY `articleid` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
